...
While go=0
 ...
 If promoStage=0 And promoTim>25 And promoTim<325
  ...
  Outline(CellName$(pChar(1))+translate(". So, ")+charName$(pChar(2))+translate(", what's the story?"),rX#(400),rY#(560),30,30,30,250,250,250)
 ...
 If gamWarrant(slot)=0
  If promoStage=2
   If promoTim>25 And promoTim<325
    ...
    Outline(charName$(gamChar(slot))+translate(", this court has seen you accused"),rX#(400),rY#(520),30,30,30,250,250,250)
    Outline(translate("of ")+Lower$(textCrime$(charCrime(gamChar(slot))))+translate(" and heard your defence..."),rX#(400),rY#(560),30,30,30,250,250,250)
   EndIf
   ...
   If promoTim>700 And promoTim<1000
    ...
    Outline(charSentence(gamChar(slot))+translate(" days in Southtown Correctional Facility!"),rX#(400),rY#(560),30,30,30,250,250,250)
   EndIf
 ...
 If gamWarrant(slot)=1
  ...
  If promoStage=0
   If promoTim>350 And promoTim<650
    Speak(2,1)
    Outline(CellName$(pChar(1))+translate(" seems to have a problem with authority!"),rX#(400),rY#(520),30,30,30,250,250,250)
 ...
 If gamWarrant(slot)=2
  ...
  If promoStage=0
   If promoTim>350 And promoTim<650
    Speak(2,1)
    Outline(CellName$(pChar(1))+translate(" is a known member of '")+textGang$(charGang(gamChar(slot)))+translate("';"),rX#(400),rY#(520),30,30,30,250,250,250)
 ...
 If gamWarrant(slot)=3
  ...
  If promoStage=0
   If promoTim>350 And promoTim<650
    Speak(2,1)
    Outline(CellName$(pChar(1))+translate(" was caught out of his cell during"),rX#(400),rY#(520),30,30,30,250,250,250)
 ...
 If gamWarrant(slot)=4
  ...
  If promoStage=0
   If promoTim>350 And promoTim<650
    ...
    EndIf
    If weapHabitat(weapType(gamItem(slot)))>0
     Outline(CellName$(pChar(1))+translate(" was caught carrying a ")+Lower$(weapName$(weapType(gamItem(slot))))+translate(" where"),rX#(400),rY#(520),30,30,30,250,250,250)
     Outline(translate("it didn't belong! God knows what he had planned..."),rX#(400),rY#(560),30,30,30,250,250,250)
    EndIf
    If promoTim>450 And promoReact(2)=0 Then PlaySound sJury(Rnd(1,2)) : promoReact(2)=1
   EndIf
   If promoTim>675 And promoTim<975
    Speak(1,1)
    Outline(translate("I found that ")+Lower$(weapName$(weapType(gamItem(slot))))+translate(", and was on my way to"),rX#(400),rY#(520),30,30,30,250,250,250)
  ...
  If promoStage=2 And promoVerdict=1
   If promoTim>325 And promoTim<625
    ...
    Outline(translate("that this ")+Lower$(weapName$(weapType(gamItem(slot))))+translate(" was used for any crime!"),rX#(400),rY#(560),30,30,30,250,250,250)
   EndIf
   If promoStage=2 And promoTim>650 And promoTim<950 And promoVerdict=1
    Speak(5,1) : pFoc(5)=2
